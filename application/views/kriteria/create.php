	...
	<div class="card-body">
		<div class="row">
			...
			<div class="form-group col-md-6">
				...
				<input type="number" step="0.01" name="bobot_kriteria" class="form-control" required>

			</div>

			<div class="form-group col-md-6">

				<label class="font-weight-bold">Sifat Kriteria</label>
			...
			<div class="form-group col-md-6">
				...
				<select name="fungsi_preferensi" class="form-control" required>
					...
					<option value="Linear with Indifference Area">
